...
from lib.model.tdcnn.drsn  import drsn34,  drsn_tdcnn
...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset',default='thumos14', type=str,
                      help='test dataset')
    parser.add_argument('--net', dest='net',default='drsn34', type=str, choices=['c3d', 'res34', 'drsn34'],
...
if __name__ == '__main__':
    ...
    if args.net == 'c3d':
        ...
        tdcnn_demo = drsn_tdcnn(depth=34, pretrained=False)
    else:
