...
def generate_classes():
  META_FILE =r'D:\2022年上\R-C3D-master\experiments\thumos14\test\new_python_evaluation_code_follow_activityNet\Evaluation\annotation\annotation_test\detclasslist.txt'
  with open(META_FILE, "r") as myfile:
    data=myfile.readlines()
  classes = {0: 'Background'}
  for vinfo in data:
      classes[int(vinfo.split()[0])] = vinfo.split()[1]
  return classes
